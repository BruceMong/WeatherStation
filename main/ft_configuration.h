...
extern void ft_modifCapteurs(char* name, short *valuePara, short valueInsere, short max, short min);
extern short ft_strlength(char *str);
extern boolean ft_isCaraNum(char c);
extern boolean ft_isCaraColon(char c);
extern boolean ft_checkStrHoraire(char* str, short size);
...
extern boolean ft_imput_LFT(char *str, short *var);
